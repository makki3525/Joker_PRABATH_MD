...
module.exports = {
  ...
  sessionName: process.env.SESSION_ID || 'PRABATH-MD::UFJBQkFUSC1NRDo6c2Vzc2lvbl9yYV8yMmY5NmRiZTRlOTdkMF92aTo6Tm90ZXNIYWlybGluZQo6OjExYWQ0MWZlODk3ZDM4MTdlNDhkZjY4ZDRiMTU=',
  author: process.env.PACK_INFO.split(";")[0] || 'M makki', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'false',
  packname: process.env.PACK_INFO.split(";")[1] || 'Makki',
